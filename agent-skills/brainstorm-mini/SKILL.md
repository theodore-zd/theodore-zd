...
1. **Restate the problem** in one sentence to confirm shared understanding
2. **Generate 2–5 approaches**, each with 1-line tradeoff summary
3. **List open questions** — things that would change the direction
4. **Ask** via `ask` tool which direction to pursue
